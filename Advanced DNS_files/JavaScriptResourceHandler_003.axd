var DomainInfoRes = {
	...
	alert_WgAutoTurnOn: "Auto-renew is currently turned off for your Domain Privacy. Would you like to turn it on?",
	alert_WgPremiumDnsAutoTurnOn: "You're about to turn on auto-renewal for your domain. Would you like to turn on auto-renewal for your domain's Domain Privacy and PremiumDNS services as well?",
	...
	error_Contextual_PushWarningWGEnabledContactsNotChanged: "Domain ownership change completed with Domain Privacy enabled.",
	...
	error_Site_PushWarningWGEnabledContactsNotChanged: "Domain ownership change completed with Domain Privacy enabled.",
	...
	failure_Alert_Domain_Expired: "Domain is expired.Failed to turn Domain Privacy {[whoisAction]}.",
	...
	failure_Alert_WhoisGuardAutoRenewDisable: "Failed to turn Domain Privacy auto-renew off",
	failure_Alert_WhoisGuardAutoRenewEnable: "Failed to turn Domain Privacy auto-renew on",
	...
	failure_Alert_WhoisGuardOnOff: "Failed to turn Domain Privacy {[whoisAction]}.",
	failure_Alert_WhoisGuardRefreshDuration: "Sorry, we weren\u2019t able to refresh the Domain Privacy Email Auto Update timeframe. Please try again.",
	...
	prompt_Content_AutoRenew_PM1: "You're about to turn on auto-renewal for your domain. Would you like to turn on auto-renewal for your domain's Domain Privacy and PremiumDNS services as well?",
	prompt_Content_AutoRenew_PM2: "You're about to turn on auto-renewal for your domain. Would you like to turn on auto-renewal for your domain's Domain Privacy service as well?",
	...
	prompt_Content_AutoRenew_PM4: "You\u2019re about to turn off auto-renewal for your domain. Please note that this action will also disable auto-renewal for Domain Privacy and PremiumDNS services associated with the domain. Would you like to proceed?",
	prompt_Content_AutoRenew_PM5: "You\u2019re about to turn off auto-renewal for your domain. Please note that this action will also disable auto-renewal for Domain Privacy service associated with the domain. Would you like to proceed?",
	...
	prompt_Content_AutoRenew_PM7: "You're about to turn on auto-renewal for your domain's Domain Privacy service. Please note that this action will also enable auto-renewal for your domain. Would you like to proceed?",
	...
	prompt_Titel_AutoRenew_WGTurnOn: "Turn On Domain Privacy Auto-Renewal",
	...
	static_AutoRenewWhoisguard: "Auto-renew Domain Privacy every year",
	...
	static_ChangeForwardedEmail: "Select the email address to which all correspondence received at \u201CDomain Privacy Email Address\u201D will be forwarded to",
	...
	static_ListDomainOnTheMarketplace: "List a domain on the Marketplace",
	...
	static_Loading_WhoisGuardAutoRenewEnableDisable: "Enable/Disable Domain Privacy Auto-Renew request is being processed.",
	static_Loading_WhoisGuardOnOff: "Turning {[whoisAction]} Domain Privacy.",
	...
	static_ManageUpdates: "Select the periodicity of Domain Privacy Email address updates",
	...
	static_PrivateEmail_Intro: "Communicate like a pro with you@yourdomain email addresses. Private Email is a secure, efficient solution with powerful productivity tools. Build trust, stay organized, and grow your business on any device.",
	...
	static_PubliContactIntro: "Domain Privacy is a service that allows customers to keep their domain contacts confidential from spammers, marketing firms and online fraudsters. When purchased, the Domain Privacy subscription is permanently assigned to a domain and stays attached to it as long as the fee is paid.",
	...
	static_ReceiveEmailsAtIntro: "Emails to Domain Privacy Email Address are forwarded here.",
	...
	static_RegistrantEmail: "Registrant contact email address",
	...
	static_Whoisguard: "Domain Privacy",
	static_WhoisGuardAddress: "Domain Privacy Address",
	static_WhoisGuardAddressIntro: "Shown in place of your address in public Whois.",
	static_WhoisguardIsOff: "Domain Privacy protection is OFF",
	static_WhoisguardIsOn: "Domain Privacy protection is ON",
	static_WhoisguardNeverTurnedOn: "Domain Privacy protection has never been turned ON",
	...
	success_Alert_WhoisGuardAutoRenewDisable: "Domain Privacy Auto-Renew was disabled with success.",
	success_Alert_WhoisGuardAutoRenewEnable: "Domain Privacy Auto-Renew was enabled with success.",
	success_Alert_WhoisGuardChangeForwardedEmail: "Forwarding Email Address has been updated.",
	success_Alert_WhoisGuardOff: "Domain Privacy has been turned OFF.",
	success_Alert_WhoisGuardOn: "Domain Privacy has been turned ON.",
	success_Alert_WhoisGuardRefreshDuration: "Domain Privacy Email Auto Update timeframe has been refreshed.",
	...
	success_site_updateContactWithoutWGEmail: "Domain contacts updated. Domain Privacy email address unchanged.",
	success_site_updateContactWithWGEmail: "Domain contacts updated. Note: Domain Privacy email address also changed.",
	...
	tooltip_Whoisguard: "What is this?  <a href=\"https://www.namecheap.com/security/what-is-domain-privacy-definition/\" target=\"_blank\">Learn More &rarr;</a>"
};
